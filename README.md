...
```env
# Blog API URL
NEXT_PUBLIC_BLOG_API_URL=https://blogv2.omerald.com
BLOG_API_BASE_URL=https://blogv2.omerald.com

# Diagnostic Center API Base URL (optional, used in some API calls)
DC_API_BASE_URL=https://diagnostic.omerald.com
NEXT_PUBLIC_DC_API_BASE_URL=https://diagnostic.omerald.com

ADMIN_API_BASE_URL=https://admin.omerald.com
NEXT_PUBLIC_ADMIN_API_BASE_URL=https://admin.omerald.com

NEXT_PUBLIC_DEV_URL=https://omerald-dev.vercel.app
