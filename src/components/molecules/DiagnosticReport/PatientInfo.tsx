  ...
  return (
    <div className="mx-10 my-5 p-4">
      <div className="flex items-start justify-between gap-6">
        <div className="flex-1 border-r border-gray-400 pr-6">
          <div>
            <h2 className="text-lg font-semibold mb-2">{patientName}</h2>
            {patientDOB && <p className="text-sm mb-1">Age: {calculateAge(patientDOB)}</p>}
            <p className="text-sm mb-1">Sex: {patientGender}</p>
            {patientContact && <p className="text-sm mb-1">Contact: {patientContact}</p>}
            {patientPID && <p className="text-sm">PID: {patientPID}</p>}
          </div>
        </div>
        <div className="flex-1 border-r border-gray-400 px-6">
          <div>
            <h3 className="text-left font-semibold mb-2">Sample Collected From:</h3>
            <p className="text-sm mb-2">{branchName}</p>
            <p className="text-sm">Pathologist: {pathologist}</p>
          </div>
        </div>
        <div className="flex-1 px-6">
          <div className="text-sm">
            <h3 className="text-left font-semibold mb-2">Report Dates:</h3>
            <p className="mb-1">
