      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl my-2 sm:my-4 md:my-8 max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mobile-scroll" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
          ...
          {shouldShowTabs && activeTab === 'report' && shouldShowDiagnosticReport && (
            <div className="max-h-[calc(95vh-200px)] overflow-y-auto -mx-2 sm:mx-0">
          ...
          {shouldShowPDFViewer && reportFiles.length > 0 && (
            <div className="w-full">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50" style={{ minHeight: 'min(600px, calc(100vh - 300px))', height: 'min(600px, calc(100vh - 300px))' }}>
                <ReportViewer
          ...
          {shouldShowEmbeddedViewer && reportFiles.length > 0 ? (
            <div className="w-full">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-900 relative" style={{ minHeight: 'min(600px, calc(100vh - 300px))', height: 'min(600px, calc(100vh - 300px))' }}>
                <ReportViewer
                  files={reportFiles.map((url: string) => signedUrls[url] || url)}
                  fileTypes={reportFiles.map((url: string) => {
                    const fileType = getFileType(url);
