...
const DC_API_BASE_URL = typeof window !== 'undefined' 
  ? (process.env.NEXT_PUBLIC_DC_API_BASE_URL || 'https://diagnostic.omerald.com')
  : (process.env.DC_API_BASE_URL || process.env.NEXT_PUBLIC_DC_API_BASE_URL || 'https://diagnostic.omerald.com');
